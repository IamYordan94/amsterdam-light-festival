/* Data baked in from the original API (artworks.list + cruises.options).
   Edit this file to change what the site shows. */
window.ALF_DATA = {
 "artworks": [
  {
   "id": 1,
  ...
  "addons": [
   {
    "id": 5,
    "code": "mulled",
    "name": "Mulled wine & stroopwafel",
    "description": "Served warm on board, non-alcoholic option included.",
    "price": 950,
    "perPerson": true
   },
   {
    ...
    "description": "Beer, wine and soft drinks for the full sailing.",
    "price": 1900,
    "perPerson": true
   },
   {
    ...
    "code": "audio",
    "name": "Audio guide",
    "description": "Artist commentary in 8 languages, headphones included.",
    "price": 600,
    "perPerson": true
   },
   {
    ...
    "description": "Take the wool festival blanket home. One per booking.",
    "price": 2400,
    "perPerson": false
   }
  ],
